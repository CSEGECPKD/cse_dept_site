...
export default function History() {
  return (
    <ColoredSection color="BLACK">
      <div className="mt-10 mb-20 space-y-5 px-4 md:px-28 mx-8 " id="history">
        <div className="w-full">
          ...
          <p className="mt-5 text-xl md:text-2xl text-gray-500 text-justify">
            At the heart of the digital revolution lies the Department of
            Computer Science and Engineering. We are the architects of the
            future, unraveling the mysteries of computation and transforming
            them into groundbreaking technologies. Our department offers a
            thrilling exploration into the world of computers and computational
            systems, encompassing everything from the foundational algorithms
            that power the digital age to the cutting-edge advancements in
