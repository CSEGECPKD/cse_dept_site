    ...
    <ColoredSection className="grid grid-cols-[50%_50%] min-h-full">
      <div className="bg-black text-white px-6 py-32">
        <div className="text-5xl px-20 py-24 gap-8">
          ...
          <ol className="mt-6">
            <li className="flex flex-row my-5 border-b-2 border-[#9E9E9E]">
              ...
              <div class="list-item">
                ...
                <p className="text-[16px]/[19.5px] text-[#9E9E9E] text-left font-montserrat font-normal my-5">
                  The program commenced in 2011 with an approved intake of 18
                  students. Affiliation Kerala Technological University [KTU]
                </p>
              </div>
            </li>
            <li className="flex flex-row my-5 border-b-2 border-[#9E9E9E]">
