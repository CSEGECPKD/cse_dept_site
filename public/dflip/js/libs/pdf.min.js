(function e(t, r) {
  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      function te(e) {
        U(
          e !== null && o(e) === "object" && e.length !== undefined,
        ...
        i(e, null, [
          ...
          },
          {
            ...
            value: function e(t, r) {
              ...
              var a =
                (t[0] * r[3] - t[1] * r[2] + r[2] * r[5] - r[4] * r[3]) / n;
              var i =
                (-t[0] * r[1] + t[1] * r[0] + r[4] * r[1] - r[5] * r[0]) / n;
              return [a, i];
            },
          },
          {
            ...
            value: function t(r, n) {
              ...
              return [
                Math.min(a[0], i[0], o[0], s[0]),
                Math.min(a[1], i[1], o[1], s[1]),
                Math.max(a[0], i[0], o[0], s[0]),
                Math.max(a[1], i[1], o[1], s[1]),
              ];
            },
          },
          {
    ...
    function (e, t, r) {
      ...
      if (!a._pdfjsCompatibilityChecked) {
        ...
        (function e() {
          ...
          if (
            t.classList.contains("testOne") === true &&
            t.classList.contains("testTwo") === true
          ) {
            return;
          }
      ...
      n(
        { target: "String", proto: true, forced: !s("startsWith") },
        {
          startsWith: function e(t) {
            ...
            i(t);
            var n = a(
              l(arguments.length > 1 ? arguments[1] : undefined, r.length),
            );
            var s = String(t);
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t) {
        if (!n(e)) return e;
        var r, a;
        if (t && typeof (r = e.toString) == "function" && !n((a = r.call(e))))
          return a;
        if (typeof (r = e.valueOf) == "function" && !n((a = r.call(e))))
          return a;
        if (!t && typeof (r = e.toString) == "function" && !n((a = r.call(e))))
          return a;
    ...
    function (e, t, r) {
      ...
      var a = r(91);
      n(
        { target: "Object", stat: true, forced: Object.assign !== a },
        { assign: a },
      );
    },
    function (e, t, r) {
    ...
    function (e, t, r) {
      ...
      var re = P(T, function () {
        ...
        return !(
          (z || typeof PromiseRejectionEvent == "function") &&
          (!a || e["finally"]) &&
            ...
            case se:
              if (d && (T.test(d) || d == "+" || d == "-" || d == ".")) {
                ...
                if (
                  r &&
                  (Z(e) != c(J, o) ||
                    (o == "file" && ($(e) || e.port !== null)) ||
                    (e.scheme == "file" && !e.host))
                )
                  return;
                e.scheme = o;
                if (r) {
    ...
    function (e, t, r) {
      ...
      var C = function (e) {
        return (
          x[e - 1] || (x[e - 1] = RegExp("((?:%[\\da-f]{2}){" + e + "})", "gi"))
        );
      };
      var P = function (e) {
        try {
        ...
        if (t !== undefined) {
          if (v(t)) {
            ...
            if (typeof a === "function") {
              ...
              for (h in t) if (f(t, h)) n.push({ key: h, value: t[h] + "" });
          } else {
            F(
              n,
              typeof t === "string"
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t) {
        ...
        if (a(e)) {
          r = e.constructor;
          if (typeof r == "function" && (r === Array || a(r.prototype)))
            r = undefined;
          else if (n(r)) {
            r = r[o];
    ...
    function (e, t, r) {
      ...
      var ce = function e(t) {
        ...
        return n || !l(this, r) || !l(J, r) || (l(this, N) && this[N][r])
          ? n
          : true;
      };
      ...
      n(
        { target: "Object", stat: true, forced: !s, sham: !o },
        {
          create: le,
          defineProperty: se,
          defineProperties: ue,
      ...
      n(
        ...
        { getOwnPropertyNames: he, getOwnPropertySymbols: de },
      );
      n(
        {
          target: "Object",
    ...
    function (e, t, r) {
      ...
      if (
        a &&
        typeof c == "function" &&
        (!("description" in c.prototype) || c().description !== undefined)
      ) {
        var f = {};
        var h = function e() {
          var t =
    ...
    function (e, t, r) {
      ...
      function U(e) {
        ...
        if (
          n.nativeImageDecoderSupport === undefined ||
          !v.includes(n.nativeImageDecoderSupport)
        ) {
        ...
        if (typeof n.disableCreateObjectURL !== "boolean") {
          n.disableCreateObjectURL =
            s.apiCompatibilityParams.disableCreateObjectURL || false;
        }
        ...
        R(e, [
          ...
          },
          {
            ...
            value: function e(t, r) {
              ...
              try {
                for (
                  var o = this._rangeListeners[Symbol.iterator](), s;
                  !(n = (s = o.next()).done);
                  n = true
                ) {
                  var u = s.value;
          ...
          },
          {
            ...
            value: function e(t, r) {
              ...
              this._readyCapability.promise.then(function () {
                ...
                try {
                  for (
                    var o = n._progressListeners[Symbol.iterator](), s;
                    !(e = (s = o.next()).done);
                    e = true
                  ) {
                    var u = s.value;
          ...
          },
          {
            ...
            value: function e(t) {
              ...
              this._readyCapability.promise.then(function () {
                ...
                try {
                  for (
                    var i = r._progressiveReadListeners[Symbol.iterator](), o;
                    !(e = (o = i.next()).done);
                    e = true
                  ) {
                    var s = o.value;
          ...
          },
          {
            ...
            value: function e() {
              ...
              this._readyCapability.promise.then(function () {
                ...
                try {
                  for (
                    var a = t._progressiveDoneListeners[Symbol.iterator](), i;
                    !(e = (i = a.next()).done);
                    e = true
                  ) {
                    var o = i.value;
        ...
        R(e, [
          {
            ...
            value: function e() {
              ...
              if (arguments.length > 1 || typeof arguments[0] === "number") {
                ...
                r = arguments[0];
                a =
                  typeof arguments[1] === "number" ? arguments[1] : this.rotate;
                s = typeof arguments[2] === "boolean" ? arguments[2] : false;
              }
              return new i.PageViewport({
                viewBox: this.view,
                scale: r,
                rotation: a,
                dontFlip: s,
            ...
            value: function e() {
              ...
              if (
                ...
                Object.keys(this.intentStates).some(function (e) {
                  ...
                  return (
                    r.renderTasks.length !== 0 || !r.operatorList.lastChunk
                  );
                })
              ) {
                return;
          ...
          },
          {
            ...
            value: function e(t) {
              ...
              var n = this._transport.messageHandler.sendWithStream(
                "GetOperatorList",
                t,
              );
              var i = n.getReader();
            ...
            [
              {
                ...
                value: function e(t) {
                  this._port = t;
                  this._messageHandler = new f.MessageHandler(
                    "main",
                    "worker",
                    t,
                  );
              ...
              Promise.all(r).then(function () {
                ...
                if (t._networkStream) {
                  t._networkStream.cancelAllRequests(
                    new a.AbortException("Worker was terminated."),
                  );
                }
                if (t.messageHandler) {
          ...
          },
          {
            ...
            value: function e() {
              ...
              r.on("UnexpectedResponse", function (e) {
                n._capability.reject(
                  new a.UnexpectedResponseException(e.message, e.status),
                );
              });
              r.on("UnknownError", function (e) {
                n._capability.reject(
                  new a.UnknownErrorException(e.message, e.details),
                );
              });
                ...
                switch (s) {
                  case "Font":
                    ...
                    t.fontLoader.bind(d).then(
                      ...
                      function (e) {
                        r.sendWithPromise("FontFallback", { id: i })["finally"](
                          function () {
                            t.commonObjs.resolve(i, d);
                          },
                        );
              ...
              return this.messageHandler
                ...
                .then(function (e) {
                  return {
                    ...
                    contentDispositionFilename: t._fullReader
                      ? t._fullReader.filename
                      : null,
                  };
                });
            },
        ...
        var r = (function () {
          function e(t) {
            ...
            this._useRequestAnimationFrame =
              h === true && typeof window !== "undefined";
          ...
          R(e, [
            ...
            },
            {
              ...
              value: function e() {
                ...
                this.callback(
                  r ||
                    new i.RenderingCancelledException(
        ...
        g(e, [
          ...
          },
          {
            ...
            value: function e() {
              ...
              try {
                for (
                  var o = this.times[Symbol.iterator](), s;
                  !(n = (s = o.next()).done);
                  n = true
                ) {
                  var u = s.value;
              ...
              try {
                for (
                  var d = this.times[Symbol.iterator](), v;
                  !(c = (v = d.next()).done);
                  c = true
                ) {
                  var p = v.value;
            ...
            },
            {
              ...
              get: function e() {
                ...
                if (t && typeof navigator !== "undefined") {
                  var r = /Mozilla\/5.0.*?rv:(\d+).*? Gecko/.exec(
                    navigator.userAgent,
                  );
                  if (r && r[1] < 63) {
                    t = false;
          ...
          },
          {
            ...
            value: function e(t, r) {
              ...
              try {
                ...
                (0, a.warn)(
                  'getPathGenerator - ignoring character: "'.concat(e, '".'),
                );
        ...
        m.prototype = {
          ...
          paintChar: function e(t, r, a, i) {
            ...
            if (u.disableFontFace || d) {
              ...
              if (
                f === n.TextRenderingMode.FILL ||
                f === n.TextRenderingMode.FILL_STROKE
              ) {
                o.fill();
              }
              if (
                f === n.TextRenderingMode.STROKE ||
                f === n.TextRenderingMode.FILL_STROKE
              ) {
                o.stroke();
              }
          ...
          showText: function e(t) {
            ...
            var y =
              r.textRenderingMode === n.TextRenderingMode.FILL &&
              !a.disableFontFace &&
              !r.patternFill;
            o.save();
            var b;
            ...
            if (S === 0 || A === 0) {
              ...
              if (
                w === n.TextRenderingMode.STROKE ||
                w === n.TextRenderingMode.FILL_STROKE
              ) {
                this._cachedGetSinglePixelWidth = null;
      ...
      s.prototype = {
        ...
        _processStreamMessage: function e(t) {
          ...
          var c = function e() {
            Promise.all(
              [
                r.streamControllers[u].startCall,
                r.streamControllers[u].pullCall,
                r.streamControllers[u].cancelCall,
              ].map(function (e) {
                ...
                if (n === "<") {
                  ...
                  switch (i) {
                    ...
                    case "?":
                      ...
                      if (
                        t.substring(a + s.parsed, a + s.parsed + 2) !== "?>"
                      ) {
                    ...
                    default:
                      ...
                      var h = false;
                      if (
                        t.substring(a + f.parsed, a + f.parsed + 2) === "/>"
                      ) {
                        h = true;
                      } else if (
                        t.substring(a + f.parsed, a + f.parsed + 1) !== ">"
                      ) {
                        this.onError(y.UnterminatedElement);
                        return;
                      }
    ...
    function (e, t, r) {
      ...
      var h = (function () {
        function e(t, r) {
          ...
          try {
            for (
              var s = this._queuedChunks[Symbol.iterator](), l;
              !(a = (l = s.next()).done);
              a = true
            ) {
              var c = l.value;
        ...
        p(e, [
          {
            ...
            value: function e() {
              ...
              var l = a.Util.normalizeRect([
                r.rect[0],
                n.view[3] - r.rect[1] + n.view[1],
                r.rect[2],
                n.view[3] - r.rect[3] + n.view[1],
              ]);
              ...
              if (!t && r.borderStyle.width > 0) {
                ...
                if (
                  r.borderStyle.style !== a.AnnotationBorderStyleType.UNDERLINE
                ) {
        ...
        p(t, [
          {
            ...
            value: function e() {
              ...
              try {
                for (
                  var i = this.data.options[Symbol.iterator](), o;
                  !(r = (o = i.next()).done);
                  r = true
                ) {
                  var s = o.value;
        ...
        p(e, [
          {
            ...
            value: function e() {
              ...
              if (o) {
                ...
                var u = t * (255 - o[1]) + o[1];
                var l = t * (255 - o[2]) + o[2];
                i.style.backgroundColor = a.Util.makeCssRgb(
                  s | 0,
                  u | 0,
                  l | 0,
                );
        ...
        p(t, [
          {
            ...
            value: function e() {
              ...
              try {
                for (
                  var l = t.vertices[Symbol.iterator](), c;
                  !(o = (c = l.next()).done);
                  o = true
                ) {
                  var f = c.value;
        ...
        p(t, [
          {
            ...
            value: function e() {
              ...
              try {
                for (
                  var u = t.inkLists[Symbol.iterator](), l;
                  !(i = (l = u.next()).done);
                  i = true
                ) {
                  var c = l.value;
        ...
        p(e, null, [
          {
            ...
            value: function e(t) {
              ...
              try {
                for (
                  var o = t.annotations[Symbol.iterator](), s;
                  !(r = (s = o.next()).done);
                  r = true
                ) {
                  var u = s.value;
          ...
          },
          {
            ...
            value: function e(t) {
              ...
              try {
                for (
                  var i = t.annotations[Symbol.iterator](), o;
                  !(r = (o = i.next()).done);
                  r = true
                ) {
                  var s = o.value;
                  var u = t.div.querySelector(
                    '[data-annotation-id="'.concat(s.id, '"]'),
                  );
                  if (u) {
                    u.style.transform = "matrix(".concat(
            ...
            },
            {
              ...
              value: function e(t) {
                ...
                var P =
                  r.textRenderingMode & n.TextRenderingMode.FILL_STROKE_MASK;
                if (
                  P === n.TextRenderingMode.FILL ||
                  P === n.TextRenderingMode.FILL_STROKE
                ) {
            ...
            },
            {
              ...
              value: function e(t, r) {
                ...
                s.setAttributeNS(
                  null,
                  "transform",
                  "scale(".concat(_(1 / n), " ").concat(_(-1 / a), ")"),
                );
                if (r) {
                  r.appendChild(s);
                } else {
    ...
    function (e, t, r) {
      ...
      var R = (function (e) {
        ...
        function t(e) {
          ...
          var n = function t(n) {
            if (n.statusCode === 404) {
              var o = new a.MissingPDFException(
      ...
      var E = (function (e) {
        ...
        function t(e, r, n) {
          ...
          var l = function e(t) {
            if (t.statusCode === 404) {
              var r = new a.MissingPDFException(
